...
{
    this->db = std::make_unique<QSqlDatabase>(QSqlDatabase::addDatabase("QSQLITE"));
    this->db.get()->setDatabaseName("./database/database");
...
bool Database::getSettings(QString &version,
    ...
    try {
        ...
        throw QString("db: error request get settings!");
    }
    return res;
}
...
bool Database::setSettings(int count_digit_max, bool use_minus,
    ...
    try {
        ...
        throw QString("db: error request set settings!");
    }
    return res;
}
...
bool Database::getStatistics(QString &exercise_all_time,
    ...
    try {
        ...
        throw QString("db: error request get statistics!");
    }
    return res;
}
...
bool Database::updateStatistics(QString exercise_all_time,
    ...
    try {
        ...
        throw QString("db: error request update statistics");
    }
    return res;
}
