...
QT_MOC_LITERAL(1, 9, 16), // "updateGamerCount"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "size"
QT_MOC_LITERAL(4, 32, 14) // "getGamersCount"

    },
    "Settings\0updateGamerCount\0\0size\0"
    "getGamersCount"
};
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateGamerCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Settings::updateGamerCount)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->getGamersCount(); break;
        default: break;
        }
...
// SIGNAL 0
void Settings::updateGamerCount(int _t1)
{
