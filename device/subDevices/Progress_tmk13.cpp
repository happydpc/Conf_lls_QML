...
Progress_tmk13::Progress_tmk13(QString uniqDevName) {
...
QList<QString> Progress_tmk13::getCurrentOtherData() {
    QList<QString> res;
...
bool Progress_tmk13::makeDataToComand(CommandController::sCommandData &commandData) {
    bool res = false;
