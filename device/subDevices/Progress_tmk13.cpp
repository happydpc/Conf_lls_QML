...
QString Progress_tmk13::getDevTypeName() {
    return QString::fromLocal8Bit(Progress_tmk13::name, strlen(Progress_tmk13::name));
}
...
//QStringList Progress_tmk13::getSettings() {

//}

//bool Progress_tmk13::setSettings(QStringList settigns) {
...
DeviceAbstract::E_State Progress_tmk13::getState() {
    return state;
}
    ...
    if(!commandData.deviceIdent.isEmpty()) {
        try {
            ...
            case Progress_tmk13Data::lls_write_settings: {
                ...
                //                QString password = QString::fromUtf8(commandArg.Progress_tmk13::E_param_suquence::param_password_session), 0);
...
QList<CommandController::sCommandData> Progress_tmk13::getCommandListToIdlePoll() {
...
bool Progress_tmk13::placeDataReplyToCommand(QByteArray &commandArrayReplyData) {
    ...
    if(!commandArrayReplyData.isEmpty()) {
        ...
        if(crcCalcResult == (0xff & commandArrayReplyData.at(
            ...
            case Progress_tmk13Data::lls_read_lvl_once: {
                ...
                chartData->push_back(lls_data.fuelLevel.value.value_u32 + (random()%10));
            ...
            case Progress_tmk13Data::lls_read_errors:
            {
                if(commandArrayReplyData.size() > 5) { // TODO: 10?
                    Progress_tmk13Data::T_errors t_erros;
...
bool Progress_tmk13::makeDataRequestReply(QByteArray request, QByteArray &reply) {
    bool res = false;
    uint8_t crcCalcResult = 0;
    Crc *crc = new Crc();
    reply.clear();
    ...
    if(!request.isEmpty()) {
        ...
        case Progress_tmk13Data::lls_read_lvl_once: {
            if(request.size() == 4) {
                ...
                reply.push_back(Progress_tmk13Data::lls_read_lvl_once);
            ...
            break;
        case Progress_tmk13Data::lls_send_data_enable: {
            //        if( rxSize == 4) {
            ...
            break;
        case Progress_tmk13Data::lls_send_data_default:{
            ...
            break;
        case Progress_tmk13Data::lls_set_send_time:{
            //        if( rxSize == 5) {
            ...
            break;
        case Progress_tmk13Data::lls_set_serial_number:{
            //        if (rxSize == 16) {
        ...
        case Progress_tmk13Data::lls_read_serial_number: {
            if(request.length() == 4) {
                ...
                reply.push_back(0x3E);
                reply.push_back(addr);
                reply.push_back(Progress_tmk13Data::lls_read_serial_number);
                for (i=0;i<SERIALNUMBER_STRING_SIZE;i++) {
            ...
            break;
        case Progress_tmk13Data::lls_set_personal:{
            ...
            break;
        case Progress_tmk13Data::lls_read_personal:{
            //        if(rxSize == 4) {
        ...
        case Progress_tmk13Data::lls_read_cnt: {
            reply.push_back(0x3E);
            reply.push_back(addr);
            reply.push_back(Progress_tmk13Data::lls_read_cnt);
        ...
        case Progress_tmk13Data::lls_check_address_and_pass:{
            ...
            break;
        case Progress_tmk13Data::lls_run_bootloader: {
            //        if(5 == rxSize) {
            //            if(pBuff[3] == 0x19) {
...
uint16_t Progress_tmk13::getFuel() {
    return fuel;
}

uint16_t Progress_tmk13::getFrequency() {
    return freq;
}

int8_t Progress_tmk13::getTemperature() {
    return temp;
}
#endif
