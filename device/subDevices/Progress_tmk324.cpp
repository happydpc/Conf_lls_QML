#include <QDebug>
#include "Progress_tmk324.h"
#include "other/crc.h"

Progress_tmk324::Progress_tmk324() {
...
QStringList Progress_tmk324::getSettings() {

}

bool Progress_tmk324::setSettings(QStringList settigns) {

}

QStringList Progress_tmk324::getCurrentData() {

}

QList<CommandController::sCommandData> Progress_tmk324::
getCommandListToIdlePoll(QString deviceIdent, int deviceIdentId) {
    ...
    //
    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_lvl_once;;
    retcommand.push_back(tcommand);
    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_cnt;
    retcommand.push_back(tcommand);
    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_lvl_all;
    retcommand.push_back(tcommand);
    //    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_settings;
    //    retcommand.push_back(tcommand);
    //    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_cal_table;
    //    retcommand.push_back(tcommand);
    //    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_errors;
    //    retcommand.push_back(tcommand);
    //    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_serial_number;
    //    retcommand.push_back(tcommand);
    //    tcommand.devCommand = (int)Progress_tmk324Data::lls_read_personal;
    //    retcommand.push_back(tcommand);
    return retcommand;
}

bool Progress_tmk324::makeDataToComand(CommandController::sCommandData &commandData) {
    bool res = false;
    if(!commandData.deviceIdent.isEmpty()) {
        try {
            ...
            case Progress_tmk324Data::lls_read_lvl_once: break;
            case Progress_tmk324Data::lls_send_data_enable: break;
            case Progress_tmk324Data::lls_set_send_time: break;
            case Progress_tmk324Data::lls_send_data_default: break;
            case Progress_tmk324Data::lls_read_cnt: break;
            case Progress_tmk324Data::lls_read_lvl_all: break;
            case Progress_tmk324Data::lls_read_settings: break;

            case Progress_tmk324Data::lls_write_settings: {
                // сперва заносим текущий пароль для разрешения доступа
                //                QString password = QString::fromUtf8(commandArg.Progress_tmk324::E_param_suquence::param_password_session), 0);
            ...
            case Progress_tmk324Data::lls_read_cal_table:
                break;

            case Progress_tmk324Data::lls_write_cal_table:
            {
                //                    // сперва заносим текущий пароль для разрешения доступа
                //                    for(uint8_t i=0; i<sizeof(password_session); i++) {
                //                        array.push_back(password_session[i]);
            ...
            case Progress_tmk324Data::lls_calibrate_min:
            case Progress_tmk324Data::lls_calibrate_max:
            {
                //                    // сперва заносим текущий пароль для разрешения доступа
                //                    for(uint8_t i=0; i<size    if(!commandArg.isEmpty()) {
                //                        array.push_back(0x31);
                //                        array.push_back(commandArg.at(Progress_tmk324::E_param_suquence::param_id_address));
                //                        array.push_back(commandArg.at(Progress_tmk324::E_param_suquence::param_comamnd));
                ...
                //                    case Progress_tmk324Data::lls_read_errors: break;
                //                    case Progress_tmk324Data::lls_set_serial_number: break;
                //                    case Progress_tmk324Data::lls_read_serial_number: break;
                //                    case Progress_tmk324Data::lls_set_personal: break;
                //                    case Progress_tmk324Data::lls_read_personal: break;
                //                    case Progress_tmk324Data::lls_set_new_password:
                //                    {
                //                        // сперва заносим текущий пароль для разрешения доступа
                //                        for(uint8_t i=0; i<sizeof(password_session); i++) {
                //                        array.push_back(password_session[i]);
                ...
                //                    case Progress_tmk324Data::lls_check_address_and_pass:
                //                    {
                //                        for(uint8_t i=0; i<sizeof(password_session); i++) {
                //                        array.push_back(password_session[i]);
                //                    }
                //                    }
                //                        break;
                //                    case Progress_tmk324Data::lls_run_bootloader: break;
                //                    default : break;
                //                    }
...
bool Progress_tmk324::placeDataReplyToCommand(QByteArray &commandArrayReplyData) {
    bool res = false;
        ...
        if(crcCalcResult == (0xff & commandArrayReplyData.at(
            ...
            case lls_read_settings: {
                if(commandArrayReplyData.size() > 22) {
                    ...
                    case Progress_tmk324Data::type_lls_tmk24:
                        lls_data.typeLls.value = "ТМК.24";
                        break;
                    case Progress_tmk324Data::type_lls_tmk4ux:
                        lls_data.typeLls.value = "ТМК.4UX";
                        break;
                    case Progress_tmk324Data::type_lls_tmk2u1:
...
#ifdef USE_TEST_DEV_REPLY
bool Progress_tmk324::makeDataRequestReply(QByteArray request, QByteArray &reply) {
    bool res = false;
    uint8_t crcCalcResult = 0;
    Crc *crc = new Crc();
    reply.clear();
    ...
    if(!request.isEmpty()) {
        ...
        switch(command) {
        case Progress_tmk324Data::lls_read_lvl_once: {
            if(request.size() == 4) {
                reply.push_back(0x3E);
                reply.push_back(addr);
                reply.push_back(Progress_tmk324Data::lls_read_lvl_once);
            ...
            break;
        case Progress_tmk324Data::lls_send_data_enable: {
            //        if( rxSize == 4) {
            ...
            break;
        case Progress_tmk324Data::lls_send_data_default:{
            ...
            break;
        case Progress_tmk324Data::lls_set_send_time:{
            //        if( rxSize == 5) {
            ...
            break;
        case Progress_tmk324Data::lls_set_serial_number:{
            //        if (rxSize == 16) {
            ...
            break;
        case Progress_tmk324Data::lls_read_serial_number: {
            if(request.length() == 4) {
                int i=0;
                ...
                reply.push_back(0x3E);
                reply.push_back(addr);
                reply.push_back(Progress_tmk324Data::lls_read_serial_number);
                for (i=0;i<SERIALNUMBER_STRING_SIZE;i++) {
            ...
            break;
        case Progress_tmk324Data::lls_set_personal:{
            ...
            break;
        case Progress_tmk324Data::lls_read_personal:{
            //        if(rxSize == 4) {
            ...
            break;
        case Progress_tmk324Data::lls_read_cnt: {
            reply.push_back(0x3E);
            reply.push_back(addr);
            reply.push_back(Progress_tmk324Data::lls_read_cnt);
        ...
        case Progress_tmk324Data::lls_write_cal_table: {
            ...
            break;
        case Progress_tmk324Data::lls_read_settings: {
            //        if (rxSize == 4) {
        ...
        case Progress_tmk324Data::lls_write_settings: {
            ...
            break;
        case Progress_tmk324Data::lls_read_errors:
            //        if( rxSize == 4) {
        ...
        case Progress_tmk324Data::lls_check_address_and_pass:{
            ...
            break;
        case Progress_tmk324Data::lls_run_bootloader: {
            //        if(5 == rxSize) {
            //            if(pBuff[3] == 0x19) {
...
uint16_t Progress_tmk324::getFuel() {
    return fuel;
}

uint16_t Progress_tmk324::getFrequency() {
    return freq;
}

int8_t Progress_tmk324::getTemperature() {
    return temp;
}
#endif
